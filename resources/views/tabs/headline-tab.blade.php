        ...
        <div class="col-md-8">
          ...
          <div class="box-body" style="background-color: #e3ebf6;">
            ...
            <div class="row">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-green " role="progressbar" style="width:{{data}}%;text-align: right; padding-right: 10px" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">40%</div>
              </div>
            </div>
            <!-- Foreach End here -->
            <div class="row">
