            ...
            <div class="col-md-12">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">To do:</label>
              ...
              <div class="box-footer">
                ...
                <button type="button"  
                                                                class="btn  btn-success btn-xs  pull-right">Create To-do
                                                        </button>
                                                        <div style="padding-right: 10px" class="pull-right"><a type="submit" >Cancel</a></div>
